                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">
                                Perfiles de <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Internet</span>
                            </h1>
                            <p className="text-sm text-gray-600">Configura velocidades y precios de tus planes</p>
                        </div>
                        <div className="flex items-center gap-3">
                            <motion.button
                                onClick={handleNuevo}
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold shadow-lg shadow-indigo-500/50"
                            >
                                <Plus size={18} />
                                Nuevo Perfil
                            </motion.button>
                ...
                {showForm && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl border border-indigo-100 p-8"
                        >
